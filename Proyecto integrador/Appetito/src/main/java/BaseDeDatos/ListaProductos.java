...
public class ListaProductos {
    ...
    Producto vino = new Producto("malvec trumpeter", "vino tinto 750ml",3500,17);
    ...
    Producto kiloArtesanal = new Producto("1 kilo de helado artesanal", "chicle gusto menta",6000,19);


    // ------------------------------- Cafeteria -----------------------------------------------
    Producto cafe = new Producto("Cafe", "Cafe solo o con azucar",500,10);
    Producto medialuna = new Producto("Medialuna", "Medialuna dulce",200,17);
    Producto cafeMedialuna = new Producto("Cafe + 3 medialunas", "Cafe grande y medialunas",1000,7);
    Producto cafeExpresoColombiano = new Producto("Cafe Expresso Colombiano", "Cafe recien molido",650,10);
