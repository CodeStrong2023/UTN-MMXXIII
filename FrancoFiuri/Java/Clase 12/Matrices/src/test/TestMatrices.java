...
//        }
        ...
        personas[0][1] = new Persona("Tomas");
        personas[1][0] = new Persona("Barbara");
        personas[1][1] = new Persona("Giuliano");
        personas[2][0] = new Persona("Anyi");
        personas[2][1] = new Persona("Diego");
        imprimir(personas);
    }
